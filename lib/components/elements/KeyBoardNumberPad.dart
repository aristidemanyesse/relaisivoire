...
import 'package:relaisivoire/components/elements/keyboard_button.dart';
...
class KeyBoardNumberPad extends StatelessWidget {
  final int limit;
  KeyBoardNumberPad({required this.limit, super.key});
      ...
      child: GridView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          if (index == 10) {
            ...
            return IconButton(
              icon: const Icon(Icons.backspace, color: MyColors.textprimary),
              onPressed: () {
