...
import 'package:relaisivoire/components/widgets/ScheduleItem.dart';
...
import 'package:relaisivoire/pages/ItineraireMapPage.dart';
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      Icon(Icons.storefront, size: 60, color: MyColors.primary),
            ...
            map
                ? Container(
                    ...
                    child: MainButtonInverse(
                      ...
                      onPressed: () {
                        Get.to(
                          ItineraireMapPage(listePointsRelais: [pointRelais]),
                        );
                      },
                    ),
                  )
