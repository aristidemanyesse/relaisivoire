          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Icon(Icons.inventory_2, size: 30, color: Colors.grey),
              ...
              Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Icon(Icons.location_on_sharp, size: 30, color: Colors.grey),
                  const SizedBox(width: Tools.PADDING / 2),
                  Expanded(
                    child: Column(
                      mainAxisSize: MainAxisSize.min,
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        if (!widget.colis.sold) ...{
                          Text(
                            "Total à payer au dépôt",
                            style: Theme.of(context).textTheme.bodyMedium!,
                          ),
                          Text(
                            "(peut changer après validation)",
                            style: Theme.of(context).textTheme.bodyMedium!
                                .copyWith(
