...
class _ProhibedPageState extends State<ProhibedPage>
  ...
  final List<ProduitProhibe> produitsProhibes = [
    ...
    ProduitProhibe(
      nom: "Contrefaçons",
      motif: "Propriété intellectuelle violée",
    ),
    ProduitProhibe(nom: "Produits explosifs", motif: "Risques de sécurité"),
    ProduitProhibe(
      nom: "Substances chimiques",
      motif: "Non autorisées au transport",
    ),
    ProduitProhibe(
      nom: "Espèces protégées",
      motif: "Interdites à l’import/export",
    ),
    ProduitProhibe(
      nom: "Médicaments sans ordonnance",
      motif: "Vente réglementée",
    ),
    ...
    ProduitProhibe(
      nom: "Batteries lithium non conformes",
      motif: "Risque incendie",
    ),
    ProduitProhibe(nom: "Alcool > 70%", motif: "Réglementation spécifique"),
    ProduitProhibe(
      nom: "Denrées périssables",
      motif: "Durée de conservation trop courte",
    ),
    ProduitProhibe(
      nom: "Produits surgelés",
      motif: "Chaîne du froid non garantie",
    ),
    ProduitProhibe(
      nom: "Produits frais non emballés",
      motif: "Hygiène non assurée",
    ),
    ...
    ProduitProhibe(
      nom: "Cendres funéraires",
      motif: "Nécessite autorisation spécifique",
    ),
    ProduitProhibe(
