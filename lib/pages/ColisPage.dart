...
import 'package:relaisivoire/components/widgets/HandlePayementPopup.dart';
...
import 'package:relaisivoire/components/widgets/ColisCard.dart';
import 'package:relaisivoire/pages/open_q_r_code.dart';
...
class _ColisPageState extends State<ColisPage> {
  ...
  void startCheck() {
    ...
    _timer = Timer.periodic(Duration(seconds: 7), (Timer t) async {
      ...
      if (res[0]) {
        openned = true;
        Get.bottomSheet(
          HandlePayementPopup(colis: res[1]),
          isDismissible: false,
          enableDrag: false,
        );
      } else {
  ...
  void initState() {
    super.initState();
    forMe =
        widget.colis.sender.target?.contact ==
                            ...
                            child: Hero(
                              ...
                              child: ClipRRect(
                                ...
                                child: Material(
                                  child: InkWell(
                                    onTap: () {
                                      Get.to(OpenQRCode(colis: widget.colis));
                                    },
                                    child: Container(
